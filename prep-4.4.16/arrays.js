...
// Write the command to make a copy of the array using slice. The copy should NOT
// include “Mary” or “Matt”.
people.slice(2);
...
// remove “Devon” from the array and add “Elizabeth” and “Artie”. Your array should look
// like this when you are done [“Greg”, “Mary”, “Elizabeth”, “Artie”, “James”].
const people2 = ["Greg", "Mary", "Devon", "James"];
people2.splice(2, 1, "Elizabeth", "Artie");

// Create a new variable called withBob and set it equal to the people array concatenated
